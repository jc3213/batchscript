...
if "%locale%" equ "0804" set menu=授予管理员权限
if "%locale%" equ "0404" set menu=授予管理員權限
if "%locale%" equ "0411" set menu=管理者権限を付与します
:main
...
:file
reg add "HKCR\*\shell\runas" /ve /t "REG_SZ" /d "%menu%" /f
